...
def build_prompt(board: str, neta: str, recent: str, target_date, needed, filled, product=None, pr_hour=None, hotel=None, hotel_hour=None, deal=None, deal_hour=None) -> str:
    slot_lines = "\n".join(
